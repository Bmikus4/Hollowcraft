...
(async()=>{
  ...
  try{
    ...
    // Stand well back at canopy height and shoot the silhouette against the sky.
    ...
    // and one straight up from under the edge of it
    await page.evaluate('__hc.tp('+(spot.x+5)+','+(spot.z+5)+')'); await sleep(2500);
