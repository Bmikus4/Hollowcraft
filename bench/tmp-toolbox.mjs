// Scratch: the size and placement of a held tool, GLB against procedural, measured rather than eyeballed.
...
for (const id of ['iron_axe','iron_pickaxe','iron_shovel','wood_axe','apple','alice_pack','ar15','revolver'])
  console.log(id.padEnd(14), JSON.stringify(await page.evaluate(i => window.__hc.heldBox(i), id)));
