// MUD — does it exist, is it on the RIVER BANKS rather than everywhere, and does the coast stay sand?
// node bench/tmp-mud.mjs
...
(async()=>{
  ...
  try{
    ...
    // Lay a patch on the flat and photograph it — the block itself, with no search for a natural one.
