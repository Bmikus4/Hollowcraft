...
(async()=>{
  ...
  try{
    ...
    const tNav = Date.now();
    await page.goto(base+'/'+FILE+'?perf=1&debug=1&t=210',{waitUntil:'load',timeout:120000});
    ...
    const out = { label:LABEL, file:FILE, stamp, viewport:[WIDTH,HEIGHT], runs:RUNS, quick:QUICK,
