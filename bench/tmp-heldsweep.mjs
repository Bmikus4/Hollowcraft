...
(async()=>{
  ...
  try{
    ...
    console.log('  total', r.total, 'held', r.held, 'noArm', (r.noArm||[]).length, 'offPalm', r.offPalm, 'bad', r.bad);
    console.log('  noArm:', JSON.stringify(r.noArm));
    console.log('  worst gaps:', JSON.stringify(r.worst));
