// quick render check: the 5x spear — held view + a thrown/stuck one
...
(async () => {
  ...
  try {
    ...
    await sleep(1500);
    await page.evaluate(`__hc.gun('rusty_spear')`); await sleep(600);
    await page.evaluate(`__hc.pitch(-0.15)`); await sleep(200);
    await page.screenshot({ path: path.join(OUT,'spear-held.png') });
